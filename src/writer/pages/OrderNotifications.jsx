...
export function OrderNotifications() {
  ...
  return (
    <div className="space-y-4">
      <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>Order Added Notifications {'>'} List</div>
      ...
      <div className="rounded-2xl flex items-center justify-center py-16" style={{ backgroundColor: 'var(--card-background)', border: '1px solid var(--border)' }}>
        <div className="text-center text-sm" style={{ color: 'var(--text-muted)' }}>No Order Added Notifications</div>
      </div>

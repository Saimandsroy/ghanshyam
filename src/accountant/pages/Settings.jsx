        ...
        <div className="space-y-6">
            ...
            <div className="rounded-2xl p-4" style={{ backgroundColor: 'var(--card-background)', border: '1px solid var(--border)' }}>
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <div className="font-semibold text-lg" style={{ color: 'var(--text-primary)' }}>{user?.username || user?.name || 'Accountant'}</div>
                        <div className="text-sm" style={{ color: 'var(--text-secondary)' }}>{user?.email || 'No email'}</div>
                        <span className="px-2 py-0.5 rounded text-xs mt-1 inline-block" style={{ backgroundColor: 'rgba(16, 185, 129, 0.1)', color: 'var(--success)' }}>{user?.role || 'Accountant'}</span>
                    </div>
                </div>
            </div>
